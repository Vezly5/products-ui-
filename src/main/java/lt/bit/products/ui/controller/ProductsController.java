...
public class ProductsController {
    ...
    ProductsController(ProductService service, ProductValidator validator, MessageSource messages) {
    ...
    String saveProduct(@ModelAttribute Product product, Model model) {
        try {
            ...
            model.addAttribute("errorMsg", messages.getMessage("validation.error." + e.getCode(),
                    e.getParams(), Locale.getDefault()));
